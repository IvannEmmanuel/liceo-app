...
const Map = () => {
    ...
    const containerHeight = animation.interpolate({
        inputRange: [0, 1],
        outputRange: [330, Dimensions.get("window").height * 0.8],
    });

    const subContainerTop = subContainerAnimation.interpolate({
        inputRange: [0, 1],
        outputRange: [330, 280], // Adjust these values to control subcontainer movement
    });
                    ...
                    >
                        {isExpanded && (
                            <View style={styles.imageContainer}>
                                <Image
                                    source={
                                        currentImage || selectedLocation.image
                                    }
                            ...
                            <ScrollView>
                                {isExpanded ? (
                                    <View style={styles.expandedContent}>
                                        <Text style={styles.expandedInfoHeader}>
                                            {infoHeader}
                                        </Text>
                                        <ScrollView
